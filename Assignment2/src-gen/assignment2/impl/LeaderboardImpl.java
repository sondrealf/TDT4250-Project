 ...
 * </p>
 * <ul>
 *   <li>{@link assignment2.impl.LeaderboardImpl#getPlayer <em>Player</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LeaderboardImpl extends MinimalEObjectImpl.Container implements Leaderboard {
	...
	protected EClass eStaticClass() {
		return Assignment2Package.Literals.LEADERBOARD;
	}
	...
	public EList<Player> getPlayer() {
		if (player == null) {
			player = new EObjectResolvingEList<Player>(Player.class, this, Assignment2Package.LEADERBOARD__PLAYER);
		}
		return player;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case Assignment2Package.LEADERBOARD__PLAYER:
			return getPlayer();
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case Assignment2Package.LEADERBOARD___LIST_PROFILES:
			return listProfiles();
		}
