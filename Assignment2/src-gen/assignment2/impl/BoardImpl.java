 ...
 * </p>
 * <ul>
 *   <li>{@link assignment2.impl.BoardImpl#getSquare <em>Square</em>}</li>
 *   <li>{@link assignment2.impl.BoardImpl#getSize <em>Size</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BoardImpl extends MinimalEObjectImpl.Container implements Board {
	/**
	 * The cached value of the '{@link #getSquare() <em>Square</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getSquare()
	 * @generated
	...
	public void setSize(int newSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Assignment2Package.BOARD__SIZE, oldSize, size));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case Assignment2Package.BOARD__SQUARE:
			return getSquare();
