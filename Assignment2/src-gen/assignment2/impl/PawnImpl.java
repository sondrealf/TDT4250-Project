 ...
 * </p>
 * <ul>
 *   <li>{@link assignment2.impl.PawnImpl#getName <em>Name</em>}</li>
 *   <li>{@link assignment2.impl.PawnImpl#getMoveStrategy <em>Move Strategy</em>}</li>
 *   <li>{@link assignment2.impl.PawnImpl#getBlackImgUrl <em>Black Img Url</em>}</li>
 *   <li>{@link assignment2.impl.PawnImpl#getWhitekImgUrl <em>Whitek Img Url</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PawnImpl extends MinimalEObjectImpl.Container implements Pawn {
	/**
	...
	protected EClass eStaticClass() {
		return Assignment2Package.Literals.PAWN;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Assignment2Package.PAWN__NAME, oldName, name));
	}
	...
	public void setMoveStrategy(Object newMoveStrategy) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Assignment2Package.PAWN__MOVE_STRATEGY,
	...
	public void setBlackImgUrl(String newBlackImgUrl) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Assignment2Package.PAWN__BLACK_IMG_URL,
	...
	public void setWhitekImgUrl(String newWhitekImgUrl) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Assignment2Package.PAWN__WHITEK_IMG_URL,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case Assignment2Package.PAWN__NAME:
			return getName();
		case Assignment2Package.PAWN__MOVE_STRATEGY:
			return getMoveStrategy();
		case Assignment2Package.PAWN__BLACK_IMG_URL:
			return getBlackImgUrl();
		case Assignment2Package.PAWN__WHITEK_IMG_URL:
