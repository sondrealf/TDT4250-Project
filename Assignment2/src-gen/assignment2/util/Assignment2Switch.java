...
public class Assignment2Switch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case Assignment2Package.LEADERBOARD: {
			...
			T result = caseLeaderboard(leaderboard);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	 ...
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Loadout</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseLoadout(Loadout object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseLeaderboard(Leaderboard object) {
		return null;
	}
